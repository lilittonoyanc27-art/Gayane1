...
const SOUND_GAME_WORDS: SoundWord[] = [
  ...
  { word: "Genio", sound: 'Kh' },
  { word: "Gafas", sound: 'G' },
  { word: "Gigante", sound: 'Kh' },
  { word: "Juguete", sound: 'Kh' },
  { word: "Gorra", sound: 'G' },
  { word: "Jardín", sound: 'Kh' },
  { word: "Gitano", sound: 'Kh' },
  { word: "Golpe", sound: 'G' },
  { word: "Juego", sound: 'Kh' },
  { word: "Gracia", sound: 'G' },
  { word: "Jabalí", sound: 'Kh' },
  { word: "Gota", sound: 'G' },
  { word: "Juez", sound: 'Kh' },
  { word: "Ganar", sound: 'G' },
  { word: "Jinete", sound: 'Kh' },
  { word: "Grito", sound: 'G' },
  { word: "Jugo", sound: 'Kh' },
  { word: "Globo", sound: 'G' },
  { word: "Juntar", sound: 'Kh' },
  { word: "Grasa", sound: 'G' },
  { word: "Joyero", sound: 'Kh' },
  { word: "Guapo", sound: 'G' },
];
...
export default function App() {
  ...
  // Sound-Game State
  const [gameWords, setGameWords] = useState<SoundWord[]>([]);
  ...
  const startSoundGame = () => {
    const shuffled = [...SOUND_GAME_WORDS].sort(() => Math.random() - 0.5);
  ...
  const handleSoundChoice = (choice: 'G' | 'Kh') => {
    const current = gameWords[soundGameIdx];
    if (choice === current.sound) {
      setSoundGameScore(prev => prev + 1);
      setDraggedTo(choice);
      setFeedback('correct');
      setTimeout(() => {
        if (soundGameIdx < gameWords.length - 1) {
      ...
      <header className="p-6 max-w-2xl mx-auto w-full z-10">
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="flex flex-col items-end">
             <span className="text-yellow-300 font-black text-2xl drop-shadow-md uppercase">ԳԱՅԱՆԵԻ ՀԱՄԱՐ</span>
          </div>
        </div>
      </header>
              ...
              >
                {!soundGameFinished ? (
                  ...
                  >
                    ...
                    <h2 className="text-3xl font-black mb-2">Ապրե՛ս, Գայանե!</h2>
